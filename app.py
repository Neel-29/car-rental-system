...
# Fatigue Detection System Integration
class FatigueDetector:
    ...
    def calibrate(self, capture):
        ...
        self.spf = totalTime/dummyFrames
    ...
    def process_frame(self, frame):
        if not self.calibrated:
            return {"error": "System not calibrated"}
...
def monitor_driver(rental_id):
    ...
    return render_template('driver_monitoring.html', rental=rental)
...
def process_monitoring_data():
    ...
    # Process frame data (this would be called from the frontend)
    # For now, we'll just update the monitoring record
